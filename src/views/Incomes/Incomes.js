...
const Incomes = () => {
  ...
  return (
    <div className={styles.incomes}>
      ...
      <NewCategory isNewCategoryModalVisible={isNewCategoryModalVisible} setIsNewCategoryModalVisible={setIsNewCategoryModalVisible} transactionType={transactionTypes.INCOME} />
      <EditCategory
